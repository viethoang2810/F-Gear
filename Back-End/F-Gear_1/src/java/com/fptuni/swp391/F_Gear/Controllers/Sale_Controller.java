...
import com.fptuni.swp391.F_Gear.DAO.Sale_Management;
...
public class Sale_Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Sale_Management sm = new Sale_Management();
        HashMap<String,ArrayList<Product>> proOnSale = sm.getAllProIsSaling();
        
        request.setAttribute("proOnSale",proOnSale);
