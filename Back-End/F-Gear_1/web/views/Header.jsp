                            ...
                            <ul class="body-category-list-sub-item">
                                <li class="body-category-list-sub-each-item">
                                    <div class="body-category-list-sub2-each-item">
                                        <h4>Brands</h4>
                                        <ul>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=ACER&cate=1"/>">ACER</a></li>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=ASUS&cate=1"/>">ASUS</a></li>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=MSI&cate=1"/>">MSI</a></li>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=DELL&cate=1"/>">DELL</a></li>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=LENOVO&cate=1"/>">LENOVO</a></li>
                                            <li><a href="<c:url value="./Home?action=Brand&brand=HP&cate=1"/>">HP</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="body-category-list-sub-each-item">
                                    <div class="body-category-list-sub2-each-item">
                                        <h4>Price</h4>
                                        <ul>
                                            <li><a href="<c:url value="./Home?action=Price&price=1"/>">Under 20 million</a></li>
                                            <li><a href="<c:url value="./Home?action=Price&price=2"/>">From 20 to less than 25 million</a></li>
                                            <li><a href="<c:url value="./Home?action=Price&price=3"/>">From 25 to less than 30 million</a></li>
                                            <li><a href="<c:url value="./Home?action=Price&price=4"/>">Over 30 million</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="body-category-list-sub-each-item">
                                    <div class="body-category-list-sub2-each-item">
                                        <h4>ASUS</h4>
                                        <ul>
                                            <li><a href="<c:url value="./Home?action=Series&series=ROG&cate=1"/>">ROG Series</a></li>
                                            <li><a href="<c:url value="./Home?action=Series&series=TUF&cate=1"/>">TUF Series</a></li>
                                            <li><a href="<c:url value="./Home?action=Series&series=Zephyrus&cate=1"/>">Zephyrus Series</a></li>
                                            <li><a href="<c:url value="./Home?action=Series&series=ROG Strix G&cate=1"/>">ROG Strix G</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="body-category-list-sub-each-item">
