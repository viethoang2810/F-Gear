    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <form action="./Category" style="width: 70%; margin-left: 20%;">
                        ...
                        <div class="add-modal-wrapper">
                            <div class="add-modal-content">
                                <div class="add-modal-form-wrapper" style="height: 500px;">
                                    ...
                                    <form action="./Category" class="add-form">
                                        <div class="add-input-wrapper">
                                            <label for="cateName" class="input-label">Guarantee Detail</label>
                                            <input required type="text" name="cateName" id="proName"  class="input-text" value="${category.cateName}">
                                        </div>
                            ...
                            <tbody>
                                <c:forEach var="category" items="${listOfCategory}">
                                    <tr style="vertical-align: middle;" class="table-row">
                                        <td scope="row" style="text-align: center">${category.cateID}</td>
                                        <td class="table-product_name" style="text-align: center">${category.cateName}</td>
                                        <td class="table-btns">
                                                ...
                                                <div class="edit-modal-content">
                                                    <div class="edit-modal-form-wrapper">
                                                        <div class="edit-modal-title">
                                                            <span class="modal-title" style="margin-bottom:30px;">Update Category </span>
                                                            <span> <i class="fa-solid fa-xmark exit-icon" style="font-size:2rem;margin-left: 70px; margin-bottom:30px;cursor: pointer;"></i></span>
                                                        </div>
                                                        <form action="./Category" class="edit-modal-form"  method="POST">
                                                            <input type="hidden" name="cate_ID" class="product-id" value="${category.cateID}">
                                                            <div class="edit-input-wrapper">
                                                                <label for="cateName" class="input-label">Name product</label>
                                                                <input type="text" name="cateName" value="${category.cateName}" id="proName" class="input-text productName" required="" >
                                                            </div>
                                                            
                                                            <!-- Put id of product here-->
                                                            <button type="submit" class="edit-modal-btn-action" name="adminOp"
                                                                    value="updated">Update Category</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
